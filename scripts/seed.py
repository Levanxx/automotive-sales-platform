...
def main():
    ...
    for i,name in enumerate(names):
        ...
        pid=execute('INSERT INTO prospects(name,email,phone,vehicle_id,stage,seller_id,outcome,loss_reason) VALUES(?,?,?,?,?,?,?,?)',(name,f'demo{i+1}@mail.pe',f'999000{i+1:03d}',random.choice([1,2,3]),stage,1+i%2,outcome,'Presupuesto' if outcome=='lost' else None))
        if outcome:
